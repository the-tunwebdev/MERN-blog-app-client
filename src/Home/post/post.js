...
function Post({title,imageURL,description,owner,isstrange}) {
                    ...
                    <div>
                        {
                            ...
                            <div className="px-6 pt-4 pb-2  space-x-4 flex justify-end mt-4">
                                ...
                                {isstrange ? null : <i class="fa fa-thumbs-up" style={{cursor : "pointer",fontSize : "30px" }} onClick={AddToFav} id='fav'></i>  }
